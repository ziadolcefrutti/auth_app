...
// in auth_app/test/mock/mock_usecases.dart.
...
class MockSignInUseCase extends _i1.Mock implements _i3.SignInUseCase {
  ...
  @override
  _i4.Future<_i2.UserEntity> execute(String? email, String? password) =>
      (super.noSuchMethod(
...
class MockSignInWithGoogleUseCase extends _i1.Mock
  ...
  @override
  _i4.Future<_i2.UserEntity> execute() =>
      (super.noSuchMethod(
            Invocation.method(#execute, []),
            returnValue: _i4.Future<_i2.UserEntity>.value(
              _FakeUserEntity_0(this, Invocation.method(#execute, [])),
            ),
          )
          as _i4.Future<_i2.UserEntity>);
}
